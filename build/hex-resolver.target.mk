...
OBJS := \
	...
	$(obj).target/$(TARGET)/hex-resolver.o \
...
$(builddir)/hex-resolver.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/hex-resolver.node: LIBS := $(LIBS)
$(builddir)/hex-resolver.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/hex-resolver.node: TOOLSET := $(TOOLSET)
$(builddir)/hex-resolver.node: $(OBJS) $(builddir)/nothing.a FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/hex-resolver.node
# Add target alias
.PHONY: hex-resolver
hex-resolver: $(builddir)/hex-resolver.node

# Short alias for building this executable.
.PHONY: hex-resolver.node
hex-resolver.node: $(builddir)/hex-resolver.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/hex-resolver.node
